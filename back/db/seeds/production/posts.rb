...
Post.create!(
  ...
  content: "令和2年度の所得税において共有すべき例外の取り扱いがありましたのでここで投稿します。
            \n\n あなたが、令和２年２月１日から令和2年12月31日までの期間において、新型コロナウイルス感染症及びその
            まん延防止のための措置の影響により中止若しくは延期又はその規模の縮小を行った文化芸術又はスポーツに関す
            る行事で一定のものの入場料金等の払い戻しを請求する権利の全部又は一部を放棄した場合、その払戻請求権相当額の合計額について、寄付金控除又は公益社団法人等寄附金特別控除の対象とすることができます。
            \n 以下が詳しい条件になります。
            \n\n 文部科学大臣の指定行事
